...
export const ERROR_MESSAGES = {
  ...
  MISSING_WHITELIST_AUTHORITY: "Whitelist authority account is required when whitelist is enabled",
  MISSING_SYSVAR_INSTRUCTIONS: "Sysvar instructions account is required for whitelist verification",
  WRONG_PROGRAM: "Previous instruction is not an Ed25519 verification instruction",
