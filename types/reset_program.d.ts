...
export type ResetProgram = {
  ...
  instructions: [
    {
      ...
      accounts: [
        ...
        {
          name: 'userSaleToken'
          docs: ["User's sale token account (will be created if needed)"]
          writable: true
          pda: {
            seeds: [
              {
        ...
        },
        {
          ...
          docs: ["User's payment token account for refunds"]
          writable: true
        },
        {
          name: 'vaultSaleToken'
          ...
          pda: {
            seeds: [
              {
                kind: 'const'
                value: [118, 97, 117, 108, 116, 95, 115, 97, 108, 101]
              },
              {
                kind: 'account'
                path: 'auction'
    ...
    {
      name: 'commit'
      docs: ['User commits to an auction bin']
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: 'const'
                value: [99, 111, 109, 109, 105, 116, 116, 101, 100]
              },
              {
                kind: 'account'
                path: 'auction'
    ...
    {
      name: 'decreaseCommit'
      docs: ['User decreases a commitment (renamed from revert_commit)']
      discriminator: [134, 84, 49, 225, 22, 251, 110, 176]
      accounts: [
        {
          name: 'user'
          writable: true
    ...
    },
    {
      ...
      discriminator: [40, 126, 46, 161, 192, 12, 37, 0]
      accounts: [
        {
          name: 'authority'
    ...
    },
    {
      ...
      docs: ['Get the hardcoded LaunchpadAdmin public key']
      discriminator: [8, 113, 195, 137, 50, 1, 35, 38]
      accounts: []
      args: []
      returns: 'pubkey'
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          docs: ['Authority of the sale token seller account']
          writable: true
          signer: true
        },
        {
          name: 'vaultSaleToken'
          docs: ['Vault to hold sale tokens (created as PDA)']
          writable: true
          pda: {
            seeds: [
              {
        ...
        {
          name: 'vaultPaymentToken'
          docs: ['Vault to hold payment tokens (created as PDA)']
          writable: true
          pda: {
            seeds: [
              {
    ...
    {
      name: 'withdrawFees'
      docs: ['Admin withdraws collected fees from all bins']
      ...
      accounts: [
        ...
        },
        {
          ...
          docs: ['Fee recipient account (will be created if needed)']
          writable: true
          pda: {
            seeds: [
              {
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          docs: ['Sale token recipient account (will be created if needed)']
          writable: true
          pda: {
            seeds: [
              {
        ...
        },
        {
          ...
          docs: ['Payment token recipient account (will be created if needed)']
          writable: true
          pda: {
            seeds: [
              {
  ...
  accounts: [
    ...
    {
      name: 'committed'
      discriminator: [110, 101, 81, 18, 224, 16, 150, 18]
    }
  ]
  events: [
    {
      name: 'committedAccountClosedEvent'
      discriminator: [99, 216, 87, 242, 221, 79, 123, 30]
    },
    {
      name: 'emergencyControlEvent'
      discriminator: [3, 252, 56, 49, 253, 0, 21, 181]
    }
  ]
  errors: [
    {
  ...
  types: [
    {
      name: 'auction'
      docs: ['Core auction data account', 'PDA: ["auction", sale_token_mint]']
      type: {
        kind: 'struct'
        fields: [
          {
            name: 'authority'
            docs: ['Launchpad admin']
            type: 'pubkey'
          },
          {
            name: 'custody'
            docs: ['Custody account for special permissions']
            type: 'pubkey'
          },
          {
            name: 'saleToken'
          ...
          {
            name: 'bins'
            docs: ['Auction bins (up to 10 bins)']
            type: {
              vec: {
                defined: {
                  name: 'auctionBin'
          ...
          {
            name: 'extensions'
            docs: ['Extension configuration (directly embedded)']
            type: {
              defined: {
                name: 'auctionExtensions'
              }
          ...
          {
            name: 'emergencyState'
            docs: ['Emergency control state (newly added)']
            type: {
              defined: {
                name: 'emergencyState'
              }
          ...
          },
          {
            ...
            docs: ['Fees withdrawn already']
            type: 'u64'
          },
          {
            name: 'vaultSaleBump'
            docs: ['Vault PDA bump seeds for derivation']
            type: 'u8'
          },
          {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: 'saleTokenPrice'
            docs: ['Price per sale token (in payment tokens)']
            type: 'u64'
          },
          {
            name: 'saleTokenCap'
            docs: ['Maximum sale tokens this bin can sell']
            type: 'u64'
          },
          {
            name: 'paymentTokenRaised'
            docs: ['Payment tokens actually raised in this bin']
            type: 'u64'
          },
          {
            name: 'saleTokenClaimed'
            docs: ['Sale tokens already claimed from this bin']
            type: 'u64'
          }
        ]
      }
    ...
    {
      name: 'auctionExtensions'
      docs: ['Extension configuration data (embedded in Auction)']
      type: {
        kind: 'struct'
        fields: [
          {
            name: 'whitelistAuthority'
            docs: ['Whitelist authority for access control']
            type: {
              option: 'pubkey'
            }
          },
          {
            ...
            docs: ['Per-user commitment cap (if enabled)']
            type: {
              option: 'u64'
            }
          },
          {
            name: 'claimFeeRate'
            docs: ['Claim fee rate (if enabled)']
            type: {
              option: 'u64'
            }
          }
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: 'bins'
            docs: ['All bins this user has committed to']
            type: {
              vec: {
                defined: {
                  name: 'committedBin'
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: 'userKey'
            docs: ['User who owned the committed account']
            type: 'pubkey'
          },
          {
            name: 'auctionKey'
            docs: ['The auction this commitment was for']
            type: 'pubkey'
          },
          {
            name: 'committedAccountKey'
            docs: ['The committed account that was closed']
            type: 'pubkey'
          },
          {
            name: 'rentReturned'
            docs: ['Amount of rent returned to the user (in lamports)']
            type: 'u64'
          },
          {
            name: 'committedData'
            docs: ['Snapshot of the committed account data at time of closure']
            type: {
              defined: {
    ...
    {
      name: 'committedAccountSnapshot'
      docs: ['Snapshot of Committed account data for the closure event']
      type: {
        kind: 'struct'
        fields: [
          {
          ...
          {
            name: 'bins'
            docs: ['All bins this user committed to']
            type: {
              vec: {
                defined: {
                  name: 'committedBin'
          ...
          },
          {
            ...
            docs: ['Total payment tokens committed across all bins']
            type: 'u64'
          },
          {
            name: 'totalSaleTokensClaimed'
            docs: ['Total sale tokens claimed across all bins']
            type: 'u64'
          }
        ]
      }
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: 'saleTokenClaimed'
            docs: ['Amount of sale tokens already claimed from this bin']
            type: 'u64'
          },
          {
            name: 'paymentTokenRefunded'
            docs: ['Payment tokens already refunded from this bin']
            type: 'u64'
          }
        ]
      }
    ...
    {
      name: 'emergencyControlParams'
      docs: ['Emergency control parameters for instruction']
      type: {
        kind: 'struct'
        fields: [
          {
    ...
    {
      name: 'emergencyState'
      docs: ['Emergency control state (embedded in Auction)']
      type: {
        kind: 'struct'
        fields: [
          {
            name: 'pausedOperations'
            docs: ['Paused operations bitmask']
            type: 'u64'
          }
        ]
      }
...
//# sourceMappingURL=reset_program.d.ts.map
